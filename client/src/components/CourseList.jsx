...
//       })
//       .then((result) => {
//         setData([...data, result.data]); // Update state without reload
...
//         setUDuration(response.data.duration);
//         setUMode(response.data.mode);
//         setEditId(id); // Only set editId after data has been fetched
//       })
//       .catch((error) => {
//         console.log(error);
//       });
...
//           course.id === editId ? result.data : course
//         );
//         setData(updatedCourses); // Update state without reload
...
//       .delete(`http://localhost:3000/courses/${id}`)
//       .then((response) => {
//         const filteredCourses = data.filter((course) => course.id !== id);
//         setData(filteredCourses); // Update state without reload
//       })
//       .catch((error) => {
//         console.log(error);
//       });
